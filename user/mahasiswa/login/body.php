...
<?php
	...
	<div class="logo-login">
        ...
        <form action="../../../koneksi/check-login-mahasiswa.php" class="inner-login" method="post">
		
            <h3 class="text-center title-login">Login User</h3>
            <div class="form-group">
				<label for="password" class="label-search">Nim </label>
                <input type="text" class="form-control" name="username" placeholder="Nim">
            </div>
            <div class="form-group">
